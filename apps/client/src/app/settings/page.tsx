		...
		<>
			{user ? (
				<div className="text-center flex flex-col gap-5">
					<div className="flex flex-col gap-3">
						...
						<form ref={emailFormRef} onSubmit={changeEmail} className="flex">
							<input
								...
								placeholder="email"
								required
								className="p-3 bg-transparent border border-foreground grow"
							/>
							<input
								type="submit"
								className="p-3 bg-transparent border border-foreground"
								value="submit"
							/>
						</form>
					</div>
					...
					<a onClick={logout} className="border border-foreground p-2 mt-10">
						sign out
					</a>
				</div>
			) : (
